        ...
        mockMvc.perform(get("/stations/{stationId}/statistics", stationId)
                ...
                .andDo(customDocument("statistics",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("congestion.standard[]").type(JsonFieldType.ARRAY).description("화요일 혼잡도 정보"),
                                fieldWithPath("congestion.standard[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.standard[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.standard[]").type(JsonFieldType.ARRAY).description("수요일 혼잡도 정보"),
                                fieldWithPath("congestion.standard[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.standard[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.standard[]").type(JsonFieldType.ARRAY).description("목요일 혼잡도 정보"),
                                fieldWithPath("congestion.standard[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.standard[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.standard[]").type(JsonFieldType.ARRAY).description("금요일 혼잡도 정보"),
                                fieldWithPath("congestion.standard[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.standard[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.standard[]").type(JsonFieldType.ARRAY).description("토요일 혼잡도 정보"),
                                fieldWithPath("congestion.standard[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.standard[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.standard[]").type(JsonFieldType.ARRAY).description("일요일 혼잡도 정보"),
                                fieldWithPath("congestion.standard[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.standard[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.quick").type(JsonFieldType.ARRAY).description("월요일 혼잡도 정보"),
                                ...
                                fieldWithPath("congestion.quick[]").type(JsonFieldType.ARRAY).description("화요일 혼잡도 정보"),
                                fieldWithPath("congestion.quick[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.quick[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.quick[]").type(JsonFieldType.ARRAY).description("수요일 혼잡도 정보"),
                                fieldWithPath("congestion.quick[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.quick[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.quick[]").type(JsonFieldType.ARRAY).description("목요일 혼잡도 정보"),
                                fieldWithPath("congestion.quick[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.quick[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.quick[]").type(JsonFieldType.ARRAY).description("금요일 혼잡도 정보"),
                                fieldWithPath("congestion.quick[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.quick[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.quick[]").type(JsonFieldType.ARRAY).description("토요일 혼잡도 정보"),
                                fieldWithPath("congestion.quick[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.quick[].ratio").type(JsonFieldType.NUMBER).description("혼잡도"),
                                fieldWithPath("congestion.quick[]").type(JsonFieldType.ARRAY).description("일요일 혼잡도 정보"),
                                fieldWithPath("congestion.quick[].hour").type(JsonFieldType.NUMBER).description("시간"),
                                fieldWithPath("congestion.quick[].ratio").type(JsonFieldType.NUMBER).description("혼잡도")
                        )));
    }
