...
import static com.carffeine.carffeine.fixture.chargerstation.ChargerFixture.잠실역_충전기_1번_사용_중;
...
public class ChargeStationFixture {
    ...
    public static final ChargeStation 잠실역_충전소_충전기_2개_사용가능_1개 = ChargeStation.builder()
            .stationId("ME101011")
            .stationName("잠실역 충전소")
            .companyName("볼튼")
            .address("잠실역 123-22")
