...
import static com.carffeine.carffeine.report.domain.QFaultReport.faultReport;
import static com.carffeine.carffeine.station.domain.QStation.station;
...
public class StationQueryRepository {
    ...
    public List<StationSimpleResponse> findStationByStationIds(List<String> stationIds) {
        return jpaQueryFactory
                ...
                .on(charger.stationId.eq(chargerStatus.stationId)
