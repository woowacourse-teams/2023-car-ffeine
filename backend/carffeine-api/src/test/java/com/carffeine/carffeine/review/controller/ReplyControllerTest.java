...
import static com.carffeine.carffeine.fixture.review.ReplyFixture.답글_1개;
import static com.carffeine.carffeine.fixture.review.ReplyFixture.바뀐_답글_1개;
...
class ReplyControllerTest extends MockBeanInjection {
    ...
    void 댓글의_답글을_조회한다() throws Exception {
        // given
        Long reviewId = 1L;
        List<ReplyResponse> replies = List.of(new ReplyResponse(1L, 1L, 1L, LocalDateTime.now(), "ad", false, false));
        int nextPage = 1;
